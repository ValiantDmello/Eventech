...
class EventRequest(models.Model):
    attendee = models.ForeignKey(EventechUser, on_delete=models.CASCADE, related_name='attendee_requests')
    admin = models.ForeignKey(EventechUser, on_delete=models.CASCADE, related_name='admin_requests')
...
class Event(models.Model):
    admin = models.ForeignKey(EventechUser, on_delete=models.CASCADE)
...
class EventAttendee(models.Model):
    ...
    attendee = models.ForeignKey(EventechUser, on_delete=models.CASCADE)
...
class Chat(models.Model):
    ...
    sender = models.ForeignKey(EventechUser, on_delete=models.CASCADE)
